...
const ROUTE_SCHEMA =
    z.object({
       ...
       // For connecting to a trace_processor_shell --httpd instance running on
       // a
       // non-standard port. This requires the CSP_WS_PERMISSIVE_PORT flag to
       // relax
       ...
       visEnd: z.string().optional().catch(undefined),
        ...
        // default({}) ensures at compile-time that every entry is either
        // optional or
        // has a default value.
        .default({});
